{ 
  ...
  new_data_frame <- data.frame(northing=c(11000000, 11500000, 12000000),
                               easting=c(10500000, 12500000, 13000000))
  
  newdataframe_SF = st_as_sf(new_data_frame,
